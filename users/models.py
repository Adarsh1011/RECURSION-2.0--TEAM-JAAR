...
class CustomAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, user_name, is_hospital, password, **other_fields):
        ...
        return self.create_user(email, user_name, is_hospital, password, **other_fields)

    def create_user(self, email, user_name, is_hospital, password, **other_fields):
        ...
        user = self.model(email=email, user_name=user_name,
                          is_hospital=is_hospital, **other_fields)
        user.set_password(password)
        user.save()
        return user
